...
describe('Your "sql_reference.json" file', () => {
  ...
  it('should have the correct properties and values added', async () => {
    assert(parsedJson.row.insert === 'INSERT INTO table_name(column_1, column_2) VALUES(value_1, value_2);' && parsedJson.column.add === 'ALTER TABLE table_name ADD COLUMN column_name;');
  });
});*/
